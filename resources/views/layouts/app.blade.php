				...
				<div class="container">
					<div class="row">
						<div class="col-lg-5 pe-lg-5 pe-xl-6 mb-5 mb-lg-0">
							...
							<p class="text-sm mb-3">We are a premier online fashion store offering the latest trends in clothing, accessories, and more. Our mission is to provide high-quality products and exceptional customer service. Shop with us and elevate your style today!</p>
						</div>
						<div class="col-lg-7">
							<div class="row">
								...
								<div class="col-lg-4"><a class="d-lg-none block-toggler my-3" data-bs-toggle="collapse" href="#footerMenu2" aria-expanded="false" aria-controls="footerMenu2">Your account<span class="block-toggler-icon"></span></a>
									...
									<div class="expand-lg collapse" id="footerMenu2">
										...
										<ul class="list-unstyled text-sm pt-2 pt-lg-0">
											@guest<li class="mb-2"> <a class="text-light text-light-hover link-animated" href="/login">Login</a></li>
											<li class="mb-2"> <a class="text-light text-light-hover link-animated" href="/register">Register</a></li>@endguest
